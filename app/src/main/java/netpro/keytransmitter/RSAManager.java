...
public class RSAManager {
    static private RSAManager sInstance;
    static private final String KEY_STORE_ALIAS = "poipoi";
    ...
    static public RSAManager getInstance(@NonNull Context context) {
        if (sInstance == null) {
            sInstance = new RSAManager(context);
        } else {
